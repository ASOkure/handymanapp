 ...
 * 
 * @Override public void saveHirer(Hirer hirer) {
 * 
 * 
 ...
 * 
 * 
 * @Override public List<Hirer> getAllHires() {
 * 
 ...
 * return hirerList; }
 * 
 * @Override public Hirer getHirerById(Long id) {
 * 
 * Session theCurrentSession = sessionFactory.getCurrentSession();
 * 
 ...
 * }
 * 
 * @Override public void updateHirer(int id) {
 * 
 * 
 * Session currentSession = sessionFactory.getCurrentSession();
 * 
 ...
 * 
 * 
 * @Override public void getHirerByLocation(Hirer hirer, String state, String
 * lga) { // TODO Auto-generated method stub
 * 
 * }
 * 
 * @Override public void deleteHirer(Long theid) {
 * 
 * Session theCurrentSession = sessionFactory.getCurrentSession();
 * 
 * Query q =
 * theCurrentSession.createQuery("Delete from Hirer where id:=hirer_id");
 * 
