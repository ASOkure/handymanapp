...
public class HirerServiceImpl implements HirerService {
	...
	@Override
	@Transactional
	public void saveHirer( Hirer theHirer) {
		
		 // simply delegate to dao to do the job
		
		hirerDao.saveHirer(theHirer);
	...
	public Hirer getHirerById(Long id) {
		...
		return  hirerDao.getHirerById(id);
